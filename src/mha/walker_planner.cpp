...
int main(int argc, char** argv) {
    ...
    if (!ph.getParam("is_simulation", is_simulation))
    {
        ROS_ERROR("Failed to retrieve param 'is_simulation' from the param server");
        return 1;
    }

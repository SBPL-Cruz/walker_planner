...
int main(int argc, char** argv){
    ...
    const int NUM_ACTION_SPACES = 10;
    //const int NUM_ACTION_SPACES = 3;
    ...
    auto dirichlet_policy = std::make_unique<DirichletPolicy>( inad_heurs.size(), 100, space.get(), dynamic_cast<BfsHeuristic*>(heurs[0].get()), door_loc ); 

...
#include "planners/mrmhaplanner_meta_a.h"
...
int main(int argc, char** argv) {
    ...
    //meta_a_policy->setRepNumQueues(rep_num_queues);

    using Planner = MRMHAPlannerMetaA<NUM_QUEUES, NUM_ACTION_SPACES, PolicyT>;
    auto search_ptr = std::make_unique<Planner>(
            space.get(), heurs_array, rep_ids, rep_dependency_matrix, meta_a_policy.get() );

...
#include "planners/rmrmhaplanner.h"
...
int RMRMHAPlanner::sampleIndex(const std::vector<double>& probs){
...
void RMRMHAPlanner::expand(MHASearchState* state, int hidx)
{

#ifndef WALKER_MHAPLNANNER_META_A_IMPLEMENTATION_H
#define WALKER_MHAPLNANNER_META_A_IMPLEMENTATION_H

#include "../mrmhaplanner_meta_a.h"
#include <panini/maths.h>
#include <panini/algo.h>

#define LOG "mrmha_meta_a"
#define E_LOG "mrmha_meta_a_expansions"
...
template <int N, int R, typename SP>
int MRMHAPlannerMetaA<N, R, SP>::replan(

#ifndef WALKER_MRMHAPLANNER_CONTEXTUAL_BANDITS_H
#define WALKER_MRMHAPLANNER_CONTEXTUAL_BANDITS_H
 ...
 */
template <int N, int R, typename SP, typename Context>
class MRMHAPlannerCoBandits : public MRMHAPlanner<N, R, SP> {
    public:
    MRMHAPlannerCoBandits(
...
#include "detail/mrmhaplanner_cobandits.hpp"
